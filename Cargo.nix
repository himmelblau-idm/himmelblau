  ...
  internal = rec {
    ...
    crates = {
      ...
      "aws-lc-rs" = rec {
        ...
        version = "1.14.0";
        edition = "2021";
        links = "aws_lc_rs_1_14_0_sys";
        sha256 = "11i7l7pddlw808xidvm5fb0qi2qnc2lclh9nlmnv2myd15ngzf4l";
        libName = "aws_lc_rs";
        authors = [
          "AWS-LibCrypto"
        ];
      ...
      "aws-lc-sys" = rec {
        ...
        edition = "2021";
        links = "aws_lc_0_31_0";
        sha256 = "1kcxz4rdglzmw7r6ni45ys1hnn35pp7956w9r6g6mbxcg1kx2i0f";
      ...
      "identity_dbus_broker" = rec {
        ...
        version = "0.1.4";
        edition = "2021";
        sha256 = "0ikx98ajn9bhky27bw1hk3d3dn0d3sgk0v0hbj63xq59z5k3kx56";
        authors = [
          "David Mulder <dmulder@suse.com>"
        ];
        dependencies = [
