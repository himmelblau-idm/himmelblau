...
def install_fallback(repo_root: Path, destdir: Path):
    ...
    fallback_assets = [
        ...
        ("platform/systemd/himmelblaud.socket", "/usr/lib/systemd/system/himmelblaud.socket", "644"),
        ("platform/systemd/himmelblaud-tasks.socket", "/usr/lib/systemd/system/himmelblaud-tasks.socket", "644"),
        ("platform/systemd/himmelblaud-broker.socket", "/usr/lib/systemd/system/himmelblaud-broker.socket", "644"),
