...
pub const DEFAULT_EMBEDDED_BROWSER_SOCK_PATH: &str = "/var/run/himmelblau-browser/browser_sock";
pub const DEFAULT_EMBEDDED_BROWSER_TIMEOUT: u64 = 300;
pub const DEFAULT_EMBEDDED_BROWSER_WIDTH: u32 = 800;
pub const DEFAULT_EMBEDDED_BROWSER_HEIGHT: u32 = 600;
pub const DEFAULT_EMBEDDED_BROWSER_CONTAINER_IMAGE: &str = "localhost/himmelblau-browser:latest";
