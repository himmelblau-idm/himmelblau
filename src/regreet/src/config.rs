...
/// Configuration for the DAG (Device Authorization Grant) browser
#[derive(Deserialize, Serialize)]
pub struct DagBrowserConfig {
    /// Enable the embedded browser for DAG authentication
    #[serde(default = "yes")]
    pub enabled: bool,
    /// Width of the browser widget
    #[serde(default = "default_dag_browser_width")]
    pub width: i32,
    /// Height of the browser widget
    #[serde(default = "default_dag_browser_height")]
    pub height: i32,
}
...
impl Default for DagBrowserConfig {
    fn default() -> Self {
        Self {
            enabled: true,
            width: default_dag_browser_width(),
            height: default_dag_browser_height(),
        }
    }
}

fn default_dag_browser_width() -> i32 {
    500
}

fn default_dag_browser_height() -> i32 {
    500
}
...
pub struct Config {
    ...
    #[serde(default)]
    pub(crate) dag_browser: DagBrowserConfig,
}
